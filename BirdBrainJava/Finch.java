...
/**
 * This class extends the BirdBrainJava.Robot class to incorporate functions to control the inputs and outputs
 * of the BirdBrainJava.Finch. It includes methods to set the values of motors and LEDs, as well
...
public class Finch extends Robot {
     ...
     * the device is a BirdBrainJava.Finch.
     */
    private boolean isFinch() {
        ...
        if (stringResponse.equals("false")) {
            System.out.println("Error: Device " + deviceInstance + " is not a BirdBrainJava.Finch");
            return false;
     ...
     * This function overrides the function in the BirdBrainJava.Robot class so that results are
