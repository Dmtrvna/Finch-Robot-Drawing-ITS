...
/**
 * This is an abstract class that is inherited by BirdBrainJava.Microbit.java, BirdBrainJava.Hummingbird.java and BirdBrainJava.Finch.java.
...
abstract class Robot {
	// Variables used to make http request to control the micro:bit (and BirdBrainJava.Hummingbird Bit)
	 ...
	 * etc.) on the micro:bit and BirdBrainJava.Hummingbird. */
