package BirdBrainJava;

/**
 * This class extends the BirdBrainJava.Microbit class to incorporate functions to control the inputs and outputs
 * of the BirdBrainJava.Hummingbird Bit. It includes methods to set the values of motors and LEDs, as well
...
public class Hummingbird extends Robot {
     ...
     *
     * @param device The letter corresponding to the BirdBrainJava.Hummingbird device, which much be "A", "B", or "C".
     * The letter that identifies the BirdBrainJava.Hummingbird device is assigned by the BlueBird Connector.
     *      */
    ...
    /** This function tries to read sensor 4 (the BirdBrainJava.Hummingbird battery) to determine whether or not
     * the device is a BirdBrainJava.Hummingbird.
     */
    private boolean isHummingbird() {
        ...
        if (stringResponse.equals("false")) {
            System.out.println("Error: Device " + deviceInstance + " is not a BirdBrainJava.Hummingbird");
            return false;
